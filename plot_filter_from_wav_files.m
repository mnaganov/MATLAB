function plot_filter_from_wav_files (start_fq, end_fq, stim_file, l_resp_file, r_resp_file, gd_scale_us, gd_smoothing)
  [freqs, start_fq, end_fq, l_freq_resp_db, l_phase_resp_deg, l_gd_us, r_freq_resp_db, r_phase_resp_deg, r_gd_us] = filter_from_wav_files(start_fq, end_fq, stim_file, l_resp_file, r_resp_file, gd_smoothing);
